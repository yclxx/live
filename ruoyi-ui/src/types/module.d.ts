...
import { handleTree, addDateRange, selectDictLabel, selectDictLabels, parseTime, numToUnitNum, getUnit, copyToClipboard } from '@/utils/ruoyi';
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    numToUnitNum : typeof numToUnitNum;
