...
public class LiveUnitTest {
    ...
    public void testTest20001() {
        ...
        for (String date : infoDate) {
            // 查询
            List<ProductLogVo> productLogVos = productLogService.queryBy10000(date);
            List<String> collect = new ArrayList<>();
            for (ProductLogVo productLogVo : productLogVos) {
                List<ProductLogVo> afterList = productLogService.queryBy10000AfterList(date, productLogVo.getProductCode(), 20);
